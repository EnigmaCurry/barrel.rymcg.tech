...
**** MARIADB_PVC_SIZE
     ...
     #+name: MARIADB_PVC_SIZE
     #+begin_src config :noweb yes :eval no
     5Gi
     #+end_src
**** MARIADB_HELM_CHART_VERSION
     ...
     #+name: MARIADB_HELM_CHART_VERSION
     #+begin_src config :noweb yes :eval no
     9.0.1
     #+end_src
...
**** MARIADB_DATABASE_USER
     ...
     #+end_src
*** MariaDB Deployment
#+INCLUDE: "~/git/vendor/enigmacurry/literate-k3s/lib/mariadb.org"
* LICENSE
